...
use mrpsdk\endpointInterfaces\schedulesResults\ResultsFeedInterface;
 ...
 */
class ResultsFeedEndpoint implements ResultsFeedInterface
{
    /**
    ...
    /**
     * ResultsFeedEndpoint constructor.
     *
     * @param $apiKey
     */
    public function __construct($apiKey)
    {
        ...
        $this->baseUrl      = 'https://api.myracepass.com/v2/schedules/results/feed/';
        $this->mrpKey       = $apiKey;
        $this->requestData  = [];
